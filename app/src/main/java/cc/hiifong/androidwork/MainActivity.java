...
import cc.hiifong.androidwork.activity.CalendarActivity;
import cc.hiifong.androidwork.activity.DateTimeAlarmActivity;
        ...
        btn.setOnClickListener(view -> {
            ...
            switch (checked){
                case R.id.btn1:
                    ...
                    break;
                case R.id.btn2:
                    intent.setClass(MainActivity.this, DateTimeAlarmActivity.class);
                    MainActivity.this.startActivity(intent);
                    break;
            }
        });
