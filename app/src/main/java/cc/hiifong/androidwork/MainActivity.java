...
import cc.hiifong.androidwork.activity.ContextMenuActivity;
import cc.hiifong.androidwork.activity.DynamicMenuActivity;
import cc.hiifong.androidwork.activity.OptionMenuActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(view -> {
            ...
            switch (checked){
                case R.id.btn1:
                    intent.setClass(MainActivity.this, OptionMenuActivity.class);
                ...
                case R.id.btn2:
                    ...
                    break;
                case R.id.btn3:
                    intent.setClass(MainActivity.this, DynamicMenuActivity.class);
                    MainActivity.this.startActivity(intent);
                    break;
            }
        });
