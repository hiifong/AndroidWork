...
import cc.hiifong.androidwork.activity.GestureActivity;
import cc.hiifong.androidwork.activity.SimpleTouchActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(view -> {
            ...
            switch (checked){
                case R.id.btn1:
                    intent.setClass(MainActivity.this, SimpleTouchActivity.class);
